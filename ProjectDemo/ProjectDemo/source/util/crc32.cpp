...
*/
quint32 CRC32::cyg_crc32_accumulate(quint32 crc32val, quint8 *s, quint32 len)
{
    quint32 i;
	for (i = 0; i < len; i++)
	{
...
*/
quint32 CRC32::cyg_crc32(quint8 *s, quint32 len)
{
...
* algorithm.
*/
quint32 CRC32::cyg_ether_crc32_accumulate(quint32 crc32val, quint8 *s, quint32 len)
{
    quint32 i;
...
*/
quint32 CRC32::cyg_ether_crc32(quint8 *s, quint32 len)
{
